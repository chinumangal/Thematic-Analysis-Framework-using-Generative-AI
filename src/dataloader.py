...
course_files = os.path.join(local_dir, "course_files", "new")
...
def dataloader(input_file, course_output_file):
    ...
    try:
        ...
        fieldnames = ['Serial number', 'Course name', 'Author', 'Date', 'Version', '1.1 Domain', '1.2 Potential AI Use Cases', '1.3 Data in the Domain', 
...
if __name__ == "__main__":
    ...
    for course_file in os.listdir(course_files):
        dataloader(course_file, course_output_file)